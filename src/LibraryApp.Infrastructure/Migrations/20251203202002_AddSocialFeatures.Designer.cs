...
namespace LibraryApp.Infrastructure.Migrations
{
    ...
    [Migration("20251203202002_AddSocialFeatures")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LibraryApp.Domain.Entities.Friendship", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("LibraryApp.Domain.Entities.Friendship", b =>
                {
                    b.HasOne("LibraryApp.Domain.Entities.User", "Addressee")
                        .WithMany("ReceivedFriendRequests")
                        .HasForeignKey("AddresseeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LibraryApp.Domain.Entities.User", "Requester")
